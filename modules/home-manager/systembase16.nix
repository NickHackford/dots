...

{
  text = ''
    ...
    call <sid>hi("PMenu",         s:gui06, s:guibg, s:cterm06, s:cterm01, "none", "")
    call <sid>hi("PMenuSel",      s:gui06, s:guibg, s:cterm06, s:cterm02, "", "")
    ...
    if has("nvim-0.8.0")
      ...
      call <sid>hi("@markup.heading",     s:gui0D, "", s:cterm0D, "", "none", "")
    endif
  ...
  '';
  target = ".config/nvim/systembase16.vim";
}
